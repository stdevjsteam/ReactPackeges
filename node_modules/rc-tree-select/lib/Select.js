  ...
  Select.getDerivedStateFromProps = function getDerivedStateFromProps(nextProps, prevState) {
    ...
    if (valueRefresh) {
      ...
      if (treeCheckable && !treeCheckStrictly) {
        ...
        newState.valueList = (0, _util2.formatInternalValue)(valueList, nextProps);
      } else {
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.onTreeNodeCheck = function (_, nodeEventInfo) {
    ...
    if (treeCheckStrictly) {
      ...
      var keyList = (0, _util2.calcUncheckConduct)(oriKeyList, nodeEventInfo.node.props.eventKey, keyEntities);
